...
public extension View {
    ...
    /// A toolbar modifier for fiori style.
    /// - Parameters:
    ///   - helperText: A `Text` displayed in toolbar stack view.
    ///   - customOverflow: A custom overflow label for wrapped items menu.
    ///   - items: Indexed views for toolbar items
    /// - Returns: A new view with a bottom tool bar.
    func fioriToolbar<Items: IndexedViewContainer>(helperText: Text, customOverflow: (any View)? = nil, @IndexedViewBuilder items: () -> Items) -> some View {
